    ...
    return (
        <section className='bg-gray-200'>
            <section className="text-center px-8">
                ...
                <figure>
                    <blockquote>
                        <p className="mt-6 max-w-3xl mx-auto text-lg">I&apos;ve written
                            <a href="https://adamwathan.me/css-utility-classNamees-and-separation-of-concerns/" className="text-sky-500 font-semibold dark:text-sky-400">a few thousand words</a>
                            on why traditional “semantic className names” are the reason CSS is hard to maintain, but the truth is you&apos;re never going to believe me until you actually try it. If you can suppress the urge to retch long enough to give it a chance, I really think you’ll wonder how you ever worked with CSS any other way.</p>
                    </blockquote>
                            ...
                            <figure className="relative flex flex-col-reverse bg-slate-50 rounded-lg p-6 dark:bg-slate-800 dark:highlight-white/5">
                                ...
                                <figcaption className="flex items-center space-x-4">
                                    ...
                                    <div className="flex-auto"><div className="text-base text-slate-900 font-semibold dark:text-slate-300">
                                        <a href="https://twitter.com/ryanflorence/status/1187951799442886656" ><span className="absolute inset-0"></span>Ryan Florence</a>
                                    </div>
                        ...
                        <li className="text-sm leading-6">
                            <figure className="relative flex flex-col-reverse bg-slate-50 rounded-lg p-6 dark:bg-slate-800 dark:highlight-white/5">
                                ...
                                <figcaption className="flex items-center space-x-4">
                                    <img src="/_next/static/media/ryan-florence.3af9c9d9.jpg" alt="" className="flex-none w-14 h-14 rounded-full object-cover" loading="lazy" decoding="async" />
                                    <div className="flex-auto"><div className="text-base text-slate-900 font-semibold dark:text-slate-300">
                                        <a href="https://twitter.com/ryanflorence/status/1187951799442886656" ><span className="absolute inset-0"></span>Debbie O'Brien</a>
                                    </div>
